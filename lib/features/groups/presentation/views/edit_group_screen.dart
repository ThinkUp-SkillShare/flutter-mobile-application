...
class _EditGroupScreenState extends State<EditGroupScreen> {
  ...
  void initState() {
    super.initState();
    _nameController = TextEditingController(text: widget.groupDetails['name']);
    _descriptionController = TextEditingController(text: widget.groupDetails['description']);
    _imageUrlController = TextEditingController(text: widget.groupDetails['coverImage']);
    _selectedSubjectId = widget.groupDetails['subjectId'];
    _loadSubjects();
  }
  ...
  Future<void> _updateGroup() async {
    ...
    try {
      ...
      final result = await GroupManagementService.updateGroup(
